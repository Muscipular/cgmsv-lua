...
---@param EnemyIdAr  number[数组] 战斗所出现的怪物队列的怪物ID数组（怪物ID为enemy.txt中的ID）。
---@param BaseLevelAr  number[数组] 战斗所出现的怪物队列的怪物等级数组（数组结构与EnemyIdAr结构应一一对应）
---@param RandLv number[数组] 战斗所出现的怪物队列的怪物等级波动数组（数组结构与EnemyIdAr结构应一一对应）
