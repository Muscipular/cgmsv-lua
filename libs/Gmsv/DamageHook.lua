...
ffi.hook.inlineHook('int (__cdecl *)(uint32_t, uint32_t, int, uint32_t)', hookAttackDamage, 0x0049B4DF, 6,
  {
    0x50, --push eax
    0x52, --push edx
    0xff, 0x75, 0x0c, -- push [ebp+c]
...
ffi.hook.inlineHook('int (__cdecl *)(uint32_t, uint32_t, int, uint32_t)', hookAttackDamage, 0x0049B406, 6,
  {
...
ffi.hook.inlineHook('int (__cdecl *)(uint32_t, uint32_t, int, uint32_t)', hookAttackDamage, 0x0049B779, 6,
  {
    0x8B, 0x95, 0xE0, 0xFE, 0xFF, 0xFF, --mov     edx, [ebp+var_120]
    0x50, --push eax
    0x52, --push edx
